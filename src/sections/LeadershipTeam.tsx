  ...
  return (
    <>
      ...
      <div className="flex gap-4 py-10">
        <ProfileCard name="Kenneth Hurley" role="Founder & CEO" image={hurleyImage}>
        ...
        <ProfileCard name="Michael Hara" role="Business Development" image={haraImage}>
        ...
        <ProfileCard name="George Northup" role="Board Member" image={northrupImage}>
